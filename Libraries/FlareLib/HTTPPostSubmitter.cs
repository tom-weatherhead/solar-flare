// HTTPPostSubmitter.cs - June 5, 2009
...
namespace FlareLib
{
    ...
    public class PostSubmitter
    {
        ...
        private string PostData(string url, string postData)
        {
            ...
            {
                // ThAW 2009/06/12 : The following two lines were moved from within the "using" block as per blog post comment.
                ...
                //request.ContentLength = postData.Length;  // ThAW 2009/06/12 : Commented out as per blog post comment.
                request.ContentLength = bytes.Length;       // ThAW 2009/06/12 : Added as per blog post comment.
